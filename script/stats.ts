...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/kreonyx/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/kreonyx...\n")
...
console.log("Fetching npm all-time downloads for kreonyx...\n")
const npmDownloads = await fetchNpmDownloads("kreonyx")
