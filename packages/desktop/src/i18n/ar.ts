export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من KREONYX CLI",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من KREONYX CLI، هل ترغب في تثبيته وإعادة تشغيله؟",
