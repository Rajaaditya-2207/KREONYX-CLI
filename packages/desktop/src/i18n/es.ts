export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de KREONYX CLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de KREONYX CLI. ¿Quieres instalarla y reiniciar?",
