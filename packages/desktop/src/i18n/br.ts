export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do KREONYX CLI",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do KREONYX CLI foi baixada. Você gostaria de instalá-la e reiniciar?",
