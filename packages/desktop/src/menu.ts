      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            ...
            text: "KREONYX CLI Documentation",
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/kreonyx"),
            text: "Support Forum",
          }),
          await PredefinedMenuItem.new({
            item: "Separator",
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/kreonyx/issues/new?template=feature_request.yml"),
            text: "Share Feedback",
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/kreonyx/issues/new?template=bug_report.yml"),
            text: "Report a Bug",
          }),
        ],
      }),
