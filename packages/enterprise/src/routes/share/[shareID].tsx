import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@kreonyx/sdk/v2"
import { SessionTurn } from "@kreonyx/ui/session-turn"
import { SessionReview } from "@kreonyx/ui/session-review"
import { DataProvider } from "@kreonyx/ui/context"
import { DiffComponentProvider } from "@kreonyx/ui/context/diff"
import { CodeComponentProvider } from "@kreonyx/ui/context/code"
import { WorkerPoolProvider } from "@kreonyx/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@kreonyx/ui/logo"
import { IconButton } from "@kreonyx/ui/icon-button"
import { ProviderIcon } from "@kreonyx/ui/provider-icon"
import { createDefaultOptions } from "@kreonyx/ui/pierre"
import { iife } from "@kreonyx/util/iife"
import { Binary } from "@kreonyx/util/binary"
import { NamedError } from "@kreonyx/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@kreonyx/ui/tabs"
import { MessageNav } from "@kreonyx/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { Diff as SSRDiff } from "@kreonyx/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@kreonyx/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@kreonyx/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@kreonyx/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@kreonyx/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/kreonyx-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | KREONYX CLI</Title>
              </Show>
              <Meta name="description" content="kreonyx - The AI coding agent built for the terminal." />
                          ...
                          <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                            <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                              ...
                              <div class="flex gap-3 items-center">
                                <IconButton
                                  as={"a"}
                                  href="https://github.com/anomalyco/kreonyx"
                                  target="_blank"
                                  icon="github"
                                  variant="ghost"
                                />
