...
import video from "../asset/lander/kreonyx-min.mp4"
import videoPoster from "../asset/lander/kreonyx-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">kreonyx</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">anomalyco/tap/kreonyx</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
