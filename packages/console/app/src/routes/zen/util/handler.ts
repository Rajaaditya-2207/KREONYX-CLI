...
import { and, Database, eq, isNull, lt, or, sql } from "@kreonyx/console-core/drizzle/index.js"
import { KeyTable } from "@kreonyx/console-core/schema/key.sql.js"
import { BillingTable, SubscriptionTable, UsageTable } from "@kreonyx/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@kreonyx/console-core/util/price.js"
import { getWeekBounds } from "@kreonyx/console-core/util/date.js"
import { Identifier } from "@kreonyx/console-core/identifier.js"
import { Billing } from "@kreonyx/console-core/billing.js"
import { Actor } from "@kreonyx/console-core/actor.js"
import { WorkspaceTable } from "@kreonyx/console-core/schema/workspace.sql.js"
import { ZenData } from "@kreonyx/console-core/model.js"
import { Black, BlackData } from "@kreonyx/console-core/black.js"
import { UserTable } from "@kreonyx/console-core/schema/user.sql.js"
import { ModelTable } from "@kreonyx/console-core/schema/model.sql.js"
import { ProviderTable } from "@kreonyx/console-core/schema/provider.sql.js"
...
export async function handler(
  ...
  const FREE_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // kreonyx bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-kreonyx-session") ?? ""
    const requestId = input.request.headers.get("x-kreonyx-request") ?? ""
    const projectId = input.request.headers.get("x-kreonyx-project") ?? ""
    const ocClient = input.request.headers.get("x-kreonyx-client") ?? ""
    logger.metric({
      is_tream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-kreonyx-request")
          headers.delete("x-kreonyx-session")
          headers.delete("x-kreonyx-project")
          headers.delete("x-kreonyx-client")
          return headers
        })(),
        body: reqBody,
      })
