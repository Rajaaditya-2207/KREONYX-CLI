...
import compareVideo from "../../asset/lander/kreonyx-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/kreonyx-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="kreonyx:auth" content={loggedin() ? "true" : "false"} />
