...
import desktopAppIcon from "../../asset/lander/kreonyx-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g kreonyx")}>
                <code>
                  npm i -g <strong>kreonyx</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g kreonyx")}>
                <code>
                  bun add -g <strong>kreonyx</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/kreonyx")}>
                <code>
                  brew install <strong>anomalyco/tap/kreonyx</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S kreonyx")}>
                <code>
                  paru -S <strong>kreonyx</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask kreonyx-desktop")}>
                <code>
                  brew install --cask <strong>kreonyx-desktop</strong>
                </code>
                <CopyStatus />
              </button>
