export const dict = {
  ...
  "dialog.provider.kreonyx.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje KREONYX CLI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u KREONYX CLI-u.",
  ...
  "provider.connect.kreonyxZen.line1":
    "KREONYX CLI Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.kreonyxZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.kreonyxZen.visit.prefix": "Posjeti ",
  "provider.connect.kreonyxZen.visit.link": "opencode.ai/zen",
  "provider.connect.kreonyxZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u KREONYX CLI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u KREONYX CLI-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u kreonyx.json",
  ...
  "dialog.server.description": "Promijeni na koji se KREONYX CLI server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija KREONYX CLI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku KREONYX CLI timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (kreonyx.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: KREONYX CLI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "KREONYX CLI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni KREONYX CLI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u KREONYX CLI-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako KREONYX CLI izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu KREONYX CLI-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se KREONYX CLI pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju KREONYX CLI-a.",
