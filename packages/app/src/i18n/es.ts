export const dict = {
  ...
  "dialog.provider.kreonyx.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por KREONYX CLI",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en KREONYX CLI.",
  ...
  "provider.connect.kreonyxZen.line1":
    "KREONYX CLI Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.kreonyxZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.kreonyxZen.visit.prefix": "Visita ",
  "provider.connect.kreonyxZen.visit.link": "opencode.ai/zen",
  "provider.connect.kreonyxZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en KREONYX CLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en KREONYX CLI.",
  ...
  "dialog.plugins.empty": "Plugins configurados en kreonyx.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de KREONYX CLI se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de KREONYX CLI ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de KREONYX CLI",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (kreonyx.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, KREONYX CLI no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "KREONYX CLI incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor KREONYX CLI dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para KREONYX CLI",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve KREONYX CLI en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de KREONYX CLI.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia KREONYX CLI",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de KREONYX CLI.",
