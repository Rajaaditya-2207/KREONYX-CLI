export const dict = {
  ...
  "dialog.provider.kreonyx.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo KREONYX CLI",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no KREONYX CLI.",
  ...
  "provider.connect.kreonyxZen.line1":
    "KREONYX CLI Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.kreonyxZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.kreonyxZen.visit.prefix": "Visite ",
  "provider.connect.kreonyxZen.visit.link": "opencode.ai/zen",
  "provider.connect.kreonyxZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no KREONYX CLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no KREONYX CLI.",
  ...
  "dialog.plugins.empty": "Plugins configurados em kreonyx.json",
  ...
  "dialog.server.description": "Trocar para qual servidor KREONYX CLI este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do KREONYX CLI ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do KREONYX CLI",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (kreonyx.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: KREONYX CLI ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "KREONYX CLI inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor KREONYX CLI dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do KREONYX CLI",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o KREONYX CLI aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o KREONYX CLI é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o KREONYX CLI iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do KREONYX CLI.",
