...
export const dict = {
  ...
  "dialog.provider.kreonyx.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av KREONYX CLI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i KREONYX CLI.",
  ...
  "provider.connect.kreonyxZen.line1":
    "KREONYX CLI Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.kreonyxZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.kreonyxZen.visit.prefix": "Besøk ",
  "provider.connect.kreonyxZen.visit.link": "opencode.ai/zen",
  "provider.connect.kreonyxZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i KREONYX CLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i KREONYX CLI.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i kreonyx.json",
  ...
  "dialog.server.description": "Bytt hvilken KREONYX CLI-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av KREONYX CLI ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til KREONYX CLI-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (kreonyx.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at KREONYX CLI ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "KREONYX CLI inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør KREONYX CLI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for KREONYX CLI",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan KREONYX CLI ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan KREONYX CLI er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når KREONYX CLI starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av KREONYX CLI.",
