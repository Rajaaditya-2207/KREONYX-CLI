...
export const dict = {
  ...
  "dialog.provider.kreonyx.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von KREONYX CLI",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in KREONYX CLI zu nutzen.",
  ...
  "provider.connect.kreonyxZen.line1":
    "KREONYX CLI Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.kreonyxZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.kreonyxZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.kreonyxZen.visit.link": "opencode.ai/zen",
  "provider.connect.kreonyxZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in KREONYX CLI zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in KREONYX CLI zu nutzen.",
  ...
  "dialog.plugins.empty": "In kreonyx.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den KREONYX CLI-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von KREONYX CLI ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem KREONYX CLI-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (kreonyx.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: KREONYX CLI unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "KREONYX CLI enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "KREONYX CLI Desktop",
  ...
  "settings.desktop.wsl.description": "KREONYX CLI-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für KREONYX CLI ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie KREONYX CLI auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von KREONYX CLI anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von KREONYX CLI automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von KREONYX CLI.",
