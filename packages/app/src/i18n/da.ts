export const dict = {
  ...
  "dialog.provider.kreonyx.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af KREONYX CLI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i KREONYX CLI.",
  ...
  "provider.connect.kreonyxZen.line1":
    "KREONYX CLI Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.kreonyxZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.kreonyxZen.visit.prefix": "Besøg ",
  "provider.connect.kreonyxZen.visit.link": "opencode.ai/zen",
  "provider.connect.kreonyxZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i KREONYX CLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i KREONYX CLI.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i kreonyx.json",
  ...
  "dialog.server.description": "Skift hvilken KREONYX CLI-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af KREONYX CLI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til KREONYX CLI-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (kreonyx.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, KREONYX CLI understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "KREONYX CLI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør KREONYX CLI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for KREONYX CLI",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan KREONYX CLI ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan KREONYX CLI er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når KREONYX CLI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af KREONYX CLI.",
