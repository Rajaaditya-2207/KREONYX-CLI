export const dict = {
  ...
  "dialog.provider.kreonyx.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez KREONYX CLI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w KREONYX CLI.",
  ...
  "provider.connect.kreonyxZen.line1":
    "KREONYX CLI Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.kreonyxZen.visit.prefix": "Odwiedź ",
  "provider.connect.kreonyxZen.visit.link": "opencode.ai/zen",
  "provider.connect.kreonyxZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w KREONYX CLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w KREONYX CLI.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w kreonyx.json",
  ...
  "dialog.server.description": "Przełącz serwer KREONYX CLI, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja KREONYX CLI ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu KREONYX CLI",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (kreonyx.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, KREONYX CLI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "KREONYX CLI zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the KREONYX CLI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla KREONYX CLI",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd KREONYX CLI na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw KREONYX CLI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania KREONYX CLI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji KREONYX CLI.",
