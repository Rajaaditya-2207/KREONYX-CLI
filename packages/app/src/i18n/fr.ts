export const dict = {
  ...
  "dialog.provider.kreonyx.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par KREONYX CLI",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans KREONYX CLI.",
  ...
  "provider.connect.kreonyxZen.line1":
    "KREONYX CLI Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.kreonyxZen.visit.prefix": "Visitez ",
  "provider.connect.kreonyxZen.visit.link": "opencode.ai/zen",
  "provider.connect.kreonyxZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans KREONYX CLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans KREONYX CLI.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans kreonyx.json",
  ...
  "dialog.server.description": "Changez le serveur KREONYX CLI auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'KREONYX CLI ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe KREONYX CLI",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (kreonyx.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'KREONYX CLI ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "KREONYX CLI inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur KREONYX CLI dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour KREONYX CLI",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'KREONYX CLI sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'KREONYX CLI.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'KREONYX CLI",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'KREONYX CLI.",
