...
import { iconNames, type IconName } from "@kreonyx/ui/icons/provider"
...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "kreonyx", key: "dialog.provider.kreonyx.note" },
...
export const SettingsProviders: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "kreonyx" || Object.values(p.models).find((m) => m.cost?.input))
  })
