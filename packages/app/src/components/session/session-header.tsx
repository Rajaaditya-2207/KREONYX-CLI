...
export function SessionHeader() {
  ...
  const leftMount = createMemo(
    () => document.getElementById("kreonyx-titlebar-left") ?? document.getElementById("kreonyx-titlebar-center"),
  )
  const rightMount = createMemo(() => document.getElementById("kreonyx-titlebar-right"))
