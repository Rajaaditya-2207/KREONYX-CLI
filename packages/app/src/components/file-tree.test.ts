...
beforeAll(async () => {
  ...
  mock.module("@kreonyx/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@kreonyx/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@kreonyx/ui/icon", () => ({ Icon: () => null }))
  mock.module("@kreonyx/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
