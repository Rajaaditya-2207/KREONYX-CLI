---
title: LSP Servers
description: KREONYX CLI integrates with your LSP servers.
---

KREONYX CLI integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

KREONYX CLI comes with several built-in LSP servers for popular languages:
...
You can customize LSP servers through the `lsp` section in your kreonyx config.
