...
description: O kreonyx integra-se aos seus servidores LSP.
---

O kreonyx integra-se ao seu Protocolo de Servidor de Linguagem (LSP) para ajudar o LLM a interagir com sua base de código. Ele usa diagnósticos para fornecer feedback ao LLM.

---

## Integrados

O kreonyx vem com vários servidores LSP integrados para linguagens populares:
...
Quando o kreonyx abre um arquivo, ele:
...
Você pode personalizar os servidores LSP através da seção `lsp` na sua configuração do kreonyx.
