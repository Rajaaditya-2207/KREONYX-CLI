---
title: TUI
description: Usando a interface de usuário de terminal kreonyx.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O kreonyx fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar kreonyx inicia o TUI para o diretório atual.
...
Ao usar o TUI do kreonyx, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao kreonyx. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do kreonyx. _Aliases_: `/quit`, `/q`
...
Você pode personalizar o comportamento do TUI através do seu arquivo de configuração do kreonyx.
