---
title: Zen
description: Lista selecionada de modelos fornecidos pelo kreonyx.
---
...
O KREONYX CLI Zen é uma lista de modelos testados e verificados fornecidos pela equipe do kreonyx.

:::note
O KREONYX CLI Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no kreonyx. Você faz login no KREONYX CLI Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o kreonyx.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o kreonyx.
:::
...
O KREONYX CLI Zen é um gateway de IA que lhe dá acesso a esses modelos.

---

## Como funciona

O KREONYX CLI Zen funciona como qualquer outro provedor no kreonyx.

1. Você faz login no **<a href={console}>KREONYX CLI Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona KREONYX CLI Zen e cola sua chave de API.
...
O [id do modelo](/docs/config/#models) na sua configuração do kreonyx usa o formato `kreonyx/<model-id>`. Por exemplo, para GPT 5.2 Codex, você usaria `kreonyx/gpt-5.2-codex` na sua configuração.
...
- GLM 4.7 Free está disponível no kreonyx por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Kimi K2.5 Free está disponível no kreonyx por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- MiniMax M2.1 Free está disponível no kreonyx por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo oculto que está gratuito no kreonyx por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
...
Criamos o KREONYX CLI Zen para:
...
4. Não ter **vinculação** permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o kreonyx também.
