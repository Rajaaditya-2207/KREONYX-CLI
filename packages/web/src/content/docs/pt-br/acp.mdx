---
title: Suporte ACP
description: Use o kreonyx em qualquer editor compatível com ACP.
---

O kreonyx suporta o [Agent Client Protocol](https://agentclientprotocol.com) ou (ACP), permitindo que você o utilize diretamente em editores e IDEs compatíveis.
...
Para usar kreonyx via ACP, configure seu editor para executar o comando `kreonyx acp`.

Este comando inicia o kreonyx como um subprocesso compatível com ACP que se comunica com seu editor via JSON-RPC através do stdio.
...
Para abri-lo, use o novo agente 'kreonyx' no seletor de agentes do AI Chat.
...
Para usar kreonyx como um agente ACP no [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), adicione o seguinte à sua configuração do Neovim:
...
Esta configuração configura o CodeCompanion para usar kreonyx como o agente ACP para chat.
...
O kreonyx funciona da mesma forma via ACP como funciona no terminal. Todos os recursos são suportados:
...
- Servidores MCP configurados na sua configuração do kreonyx
