...
description: Créez des outils que le LLM peut appeler dans kreonyx.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de kreonyx comme `read`, `write` et `bash`.
...
- Localement en les plaçant dans le répertoire `.kreonyx/tools/` de votre projet.
- Ou globalement, en les plaçant dans `~/.config/kreonyx/tools/`.
