---
title: TUI
description: Utilisation de l’interface utilisateur du terminal KREONYX CLI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KREONYX CLI fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de KREONYX CLI démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le KREONYX CLI TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à KREONYX CLI. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez KREONYX CLI. *Alias* : `/quit`, `/q`
...
Vous pouvez personnaliser le comportement de TUI via votre fichier de configuration KREONYX CLI.
