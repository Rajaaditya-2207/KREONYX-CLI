---
title: Serveurs LSP
description: KREONYX CLI s'intègre à vos serveurs LSP.
---

KREONYX CLI s'intègre via le protocole LSP (Language Server Protocol) pour aider le LLM à interagir avec votre base de code. Il utilise des diagnostics pour fournir des commentaires au LLM.

---

## Serveurs intégrés

KREONYX CLI est livré avec plusieurs serveurs LSP intégrés pour les langages populaires :
...
Lorsque kreonyx ouvre un fichier, il :
...
Vous pouvez personnaliser les serveurs LSP via la section `lsp` de votre configuration kreonyx.
