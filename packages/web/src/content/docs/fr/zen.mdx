---
title: Zen
description: Liste organisée de modèles fournis par KREONYX CLI.
---
...
KREONYX CLI Zen est une liste de modèles testés et vérifiés fournie par l'équipe KREONYX CLI.

:::note
KREONYX CLI Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans KREONYX CLI. Vous vous connectez à KREONYX CLI Zen et obtenez
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec KREONYX CLI.
:::
...
KREONYX CLI Zen est une passerelle IA qui vous donne accès à ces modèles.

---

## Comment ça marche

KREONYX CLI Zen fonctionne comme n'importe quel autre fournisseur dans KREONYX CLI.

1. Vous vous connectez à **<a href={console}>KREONYX CLI Zen</a>**, ajoutez votre facturation
   détails et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez KREONYX CLI Zen et collez votre clé API.
...
Le [id du modèle](/docs/config/#models) dans votre configuration KREONYX CLI
utilise le format `kreonyx/<model-id>`. Par exemple, pour GPT 5.2 Codex, vous devez
utilisez `kreonyx/gpt-5.2-codex` dans votre configuration.
...
- GLM 4.7 Free est disponible sur KREONYX CLI pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Kimi K2.5 Free est disponible sur KREONYX CLI pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- MiniMax M2.1 Free est disponible sur KREONYX CLI pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Big Pickle est un modèle furtif gratuit sur KREONYX CLI pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
...
Nous avons créé KREONYX CLI Zen pour :
...
4. N'ayez **aucun verrouillage** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et laissez-vous toujours utiliser n'importe quel autre fournisseur avec KREONYX CLI également.
