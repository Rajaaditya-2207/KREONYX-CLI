...
使用 kreonyx，您可以从多个内建主题中进行选择，使用适合您的终端主题的主题，或定义您自己的自定义主题。

By default, kreonyx uses our own `kreonyx` theme.
...
kreonyx 支持灵活的基于 JSON 的主题系统，允许用户轻松创建和自定义主题。
