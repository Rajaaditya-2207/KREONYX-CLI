---
title: 服务器
description: 通过 HTTP 与 kreonyx 服务器交互。
---
...
:::tip
使用kreonyx服务器以程序设计方式与kreonyx交互。
:::

该架构让 kreonyx 支持客户端，并允许您以多种设计方式与 kreonyx 交互。
...
[**_T2_**](#tui) 端点可用于跨境服务器驱动 TUI。例如，您可以预填充或执行提示。此设置由 kreonyx [IDE](/docs/ide) 外挂使用。
