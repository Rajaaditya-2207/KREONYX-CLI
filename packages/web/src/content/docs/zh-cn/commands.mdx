...
您可以通过 kreonyx 配置或通过在 `commands/` 目录中创建 markdown 文件来添加自定义命令。

---

### JSON

在 kreonyx [配置](/docs/config) 中使用 `command` 选项：
...
- 全局：`~/.config/kreonyx/commands/`
- 每个项目：`.kreonyx/commands/`
...
kreonyx 包含 `/init`、`/undo`、`/redo`、`/share`、`/help` 等内置命令；[了解更多](/docs/tui#commands)。
