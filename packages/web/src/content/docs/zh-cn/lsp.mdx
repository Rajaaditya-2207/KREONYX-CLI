---
title: LSP 服务器
description: kreonyx 与您的 LSP 服务器集成。
---

kreonyx 与您的语言服务器协议 (LSP) 集成，以帮助 LLM 与您的代码库交互。它使用诊断向 LLM 提供反馈。

---

## 内置

kreonyx 附带了多种适用于流行语言的内置 LSP 服务器：
...
您可以通过 kreonyx 配置中的 `lsp` 部分自定义 LSP 服务器。
