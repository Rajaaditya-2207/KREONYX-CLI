---
title: TUI
description: 使用 kreonyx 终端用户界面。
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

kreonyx 提供交互式终端介面或 TUI，以便使用 LLM 处理您的专案。
...
使用 kreonyx TUI 时，您可以输入 `/` 后跟命令名称来快速执行操作。例如：
...
将提供商添加到 kreonyx。你可以从可用提供商中选择，并添加它们的 API 密钥。
