...
`.kreonyx/commands/test.md` oluştur:
...
kreonyx işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

kreonyx [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/kreonyx/commands/`
- Proje başına: `.kreonyx/commands/`
...
kreonyx, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
