...
Ajan becerileri, kreonyx'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
kreonyx su konumlari tarar:

- Proje konfigurasyonu: `.kreonyx/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/kreonyx/skills/<name>/SKILL.md`
...
Proje yerel yollarinda kreonyx, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.kreonyx/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/kreonyx/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.kreonyx/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
kreonyx, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`kreonyx.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`kreonyx.json` icinde):
