---
title: TUI
description: kreonyx terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

kreonyx, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

kreonyx'u calistirdiginizda mevcut dizin icin TUI baslar.
...
kreonyx TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
kreonyx'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
kreonyx'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini kreonyx config dosyanizdan ozellestirebilirsiniz.
