---
title: Özel Araçlar
description: LLM'un kreonyx'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. kreonyx'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.kreonyx/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/kreonyx/tools/` içine yerleştirerek.
