---
title: Zen
description: kreonyx ekibinin sundugu secili model listesi.
---
...
KREONYX CLI Zen, kreonyx ekibi tarafindan test edilip dogrulanmis modellerin listesidir.

:::note
KREONYX CLI Zen su anda beta asamasindadir.
:::

Zen, kreonyx'daki diger provider'lar gibi calisir. KREONYX CLI Zen'e giris yapar ve API anahtarinizi alirsiniz.
Tamamen istege baglidir; kreonyx kullanmak icin Zen kullanmak zorunda degilsiniz.
...
:::tip
kreonyx ile iyi calisan belirli model/provider kombinasyonlarini test ettik.
:::
...
KREONYX CLI Zen, bu modellere erisim saglayan bir AI gateway'dir.

---

## Nasil calisir

KREONYX CLI Zen, kreonyx'daki diger provider'lar gibi calisir.

1. **<a href={console}>KREONYX CLI Zen</a>** hesabina giris yapin, odeme bilgilerinizi ekleyin ve API anahtarinizi kopyalayin
2. TUI'da `/connect` komutunu calistirin, KREONYX CLI Zen'i secin ve API anahtarinizi yapistirin
...
kreonyx config'inizdeki [model id](/docs/config/#models), `kreonyx/<model-id>` formatini kullanir.
Ornegin GPT 5.2 Codex icin config'te `kreonyx/gpt-5.2-codex` kullanirsiniz.
...
- GLM 4.7 Free, sinirli bir sure icin kreonyx'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Kimi K2.5 Free, sinirli bir sure icin kreonyx'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- MiniMax M2.1 Free, sinirli bir sure icin kreonyx'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Big Pickle, sinirli bir sure icin kreonyx'da ucretsiz olan gizli bir modeldir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
...
KREONYX CLI Zen'i su amaclarla olusturduk:
...
4. Herhangi bir kodlama ajaniyla kullanima izin vererek **kilitlenmeyi onlemek** ve kreonyx'da diger provider'lari her zaman acik tutmak
