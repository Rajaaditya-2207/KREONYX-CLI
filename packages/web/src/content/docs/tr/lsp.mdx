...
description: kreonyx, LSP sunucularınızla bütünleşir.
---

kreonyx, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

kreonyx, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
LSP sunucularını, kreonyx yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
