...
您 可以透過 kreonyx 設定或透過在 `commands/` 目錄中建立 markdown 檔案來新增自定義指令。

---

### JSON

在 kreonyx [設定](/docs/config) 中使用 `command` 選項：
...
- 全域：`~/.config/kreonyx/commands/`
- 每個專案：`.kreonyx/commands/`
...
kreonyx 包含 `/init`、`/undo`、`/redo`、`/share`、`/help` 等內建指令； [了解更多](/docs/tui#commands)。
