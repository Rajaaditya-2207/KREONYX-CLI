---
title: SDK
description: kreonyx 伺服器的類型安全 JS 客戶端。
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

kreonyx JS/TS SDK 提供類型安全的客戶端用於與伺服器互動。
使用它以程式化方式構建整合和控制 kreonyx。
...
您可以傳遞設定物件來自定義行為。該實例仍然會選擇您的 `kreonyx.json`，但您可以覆寫或添加內聯設定：
...
如果您已經有一個正在執行的 kreonyx 實例，您可以建立一個客戶端實例來連接到它：
