---
title: Share
description: Share your KREONYX CLI conversations.
---

KREONYX CLI's share feature allows you to create public links to your KREONYX CLI conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, KREONYX CLI:
...
KREONYX CLI supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, KREONYX CLI uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `kreonyx.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using kreonyx in your organization.
