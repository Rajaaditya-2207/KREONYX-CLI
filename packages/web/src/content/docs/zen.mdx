---
title: Zen
description: Curated list of models provided by KREONYX CLI.
---
...
KREONYX CLI Zen is a list of tested and verified models provided by the KREONYX CLI team.

:::note
KREONYX CLI Zen is currently in beta.
:::

Zen works like any other provider in KREONYX CLI. You login to KREONYX CLI Zen and get
...
:::tip
We tested a select group of models and providers that work well with KREONYX CLI.
:::
...
KREONYX CLI Zen is an AI gateway that gives you access to these models.

---

## How it works

KREONYX CLI Zen works like any other provider in KREONYX CLI.

1. You sign in to **<a href={console}>KREONYX CLI Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select KREONYX CLI Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your KREONYX CLI config
uses the format `kreonyx/<model-id>`. For example, for GPT 5.2 Codex, you would
use `kreonyx/gpt-5.2-codex` in your config.
...
- Kimi K2.5 Free is available on KREONYX CLI for a limited time. The team is using this time to collect feedback and improve the model.
- MiniMax M2.5 Free is available on KREONYX CLI for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on KREONYX CLI for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with KREONYX CLI as well.
