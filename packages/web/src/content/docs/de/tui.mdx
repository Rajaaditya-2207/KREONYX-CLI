---
title: TUI
description: Arbeite mit KREONYX CLI in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KREONYX CLI bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet KREONYX CLI die TUI im aktuellen Verzeichnis.
...
In der KREONYX CLI-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Add a provider to KREONYX CLI. Allows you to select from available providers and add their API keys.
...
Exit KREONYX CLI. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your KREONYX CLI config file.
