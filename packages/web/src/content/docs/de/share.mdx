---
title: Teilen
description: Teile KREONYX CLI-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu KREONYX CLI-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht KREONYX CLI Folgendes:
...
KREONYX CLI hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt KREONYX CLI den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`kreonyx.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du kreonyx in deiner Organisation einsetzt.
