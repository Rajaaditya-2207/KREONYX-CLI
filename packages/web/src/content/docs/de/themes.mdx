...
Mit KREONYX CLI kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet KREONYX CLI das `kreonyx`-Theme.
...
KREONYX CLI liefert mehrere eingebaute Themes mit.
...
- KREONYX CLI optisch ans Terminal anpassen wollen
...
KREONYX CLI unterstuetzt ein flexibles JSON-basiertes Theme-System.
