---
title: LSP Server
description: KREONYX CLI lässt sich in Ihren LSP-Server integrieren.
---

KREONYX CLI lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

KREONYX CLI verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn KREONYX CLI eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer KREONYX CLI-Konfiguration anpassen.
