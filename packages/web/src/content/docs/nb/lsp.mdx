---
title: LSP-servere
description: kreonyx integreres med LSP-serverne dine.
---

KREONYX CLI integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

KREONYX CLI kommer med flere innebygde LSP-servere for populære språk:
...
Når kreonyx åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i KREONYX CLI-konfigurasjonen.
