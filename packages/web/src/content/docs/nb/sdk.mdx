---
title: SDK
description: Typesikker JS-klient for KREONYX CLI-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

KREONYX CLI JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere KREONYX CLI programmatisk.
...
Opprett en forekomst av KREONYX CLI:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `kreonyx.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av KREONYX CLI, kan du opprette en klientforekomst for å koble til den:
