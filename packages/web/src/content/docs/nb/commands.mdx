...
Opprett `.kreonyx/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom KREONYX CLI-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i KREONYX CLI [config](/docs/config):
...
- Globalt: `~/.config/kreonyx/commands/`
- Per prosjekt: `.kreonyx/commands/`
...
KREONYX CLI inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
