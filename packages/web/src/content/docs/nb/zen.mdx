---
title: Zen
description: Utvalgt liste over modeller levert av KREONYX CLI.
---
...
KREONYX CLI Zen er en liste over testede og verifiserte modeller levert av KREONYX CLI-teamet.

:::note
KREONYX CLI Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i KREONYX CLI. Du logger på KREONYX CLI Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med KREONYX CLI.
:::
...
KREONYX CLI Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

KREONYX CLI Zen fungerer som alle andre leverandører i KREONYX CLI.

1. Du logger på **<a href={console}>KREONYX CLI Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger KREONYX CLI Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i KREONYX CLI-konfigurasjonen
bruker formatet `kreonyx/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `kreonyx/gpt-5.2-codex` i konfigurasjonen din.
...
- GLM 4.7 Free er tilgjengelig på KREONYX CLI i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Kimi K2.5 Free er tilgjengelig på KREONYX CLI i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- MiniMax M2.1 Free er tilgjengelig på KREONYX CLI i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på KREONYX CLI i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
Vi opprettet KREONYX CLI Zen for å:
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med kreonyx også.
