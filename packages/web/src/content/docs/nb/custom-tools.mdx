...
description: Lag verktøy som LLM kan kalle inn KREONYX CLI.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med KREONYX CLI sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.kreonyx/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/kreonyx/tools/`.
