...
KREONYX CLI มีเอเจนต์สองประเภท: **Primary Agent** (เอเจนต์หลัก) และ **Subagent** (เอเจนต์ย่อย)
...
KREONYX CLI มีเอเจนต์หลักในตัวได้แก่ **Build** และ **Plan**
...
KREONYX CLI มี subagent ในตัวได้แก่ **General** และ **Explore**

---

## บิวท์อิน

KREONYX CLI มาพร้อมกับเอเจนต์หลักและ subagent ในตัวดังนี้
...
กำหนดค่าเอเจนต์ในไฟล์ `kreonyx.json` ของคุณ:
...
- ระดับผู้ใช้ (Global): `~/.config/kreonyx/agents/`
- ระดับโปรเจ็กต์: `.kreonyx/agents/`
...
หมายเหตุ: KREONYX CLI ค่าเริ่มต้นคือ 0 สำหรับโมเดลส่วนใหญ่ และ 0.55 สำหรับโมเดล Qwen
...
:::tip
หากไม่ได้ระบุโมเดล เอเจนต์จะใช้ [โมเดลเริ่มต้น](/docs/config#models) ของ KREONYX CLI
:::
...
:::tip
ใช้ `kreonyx models` เพื่อดูรายการตัวเลือกทั้งหมด
:::
...
:::tip
คุณมีเอเจนต์เจ๋งๆ ที่ต้องการแบ่งปันหรือไม่? [ส่ง PR มาที่นี่](https://github.com/anomalyco/kreonyx)
:::
