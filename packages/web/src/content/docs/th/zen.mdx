---
title: เซน
description: รายการโมเดลที่คัดสรรโดย KREONYX CLI
---
...
KREONYX CLI Zen คือรายการโมเดลที่ได้รับการทดสอบและตรวจสอบแล้วโดยทีมงาน KREONYX CLI

:::note
KREONYX CLI Zen ปัจจุบันอยู่ในช่วงเบต้า
:::

Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน KREONYX CLI คุณเข้าสู่ระบบ KREONYX CLI Zen และรับ
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่เลือกซึ่งทำงานได้ดีกับ KREONYX CLI
:::
...
KREONYX CLI Zen เป็นเกตเวย์ AI ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## มันทำงานอย่างไร

KREONYX CLI Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน KREONYX CLI

1. คุณลงชื่อเข้าใช้ **<a href={console}>KREONYX CLI Zen</a>** เพิ่มการเรียกเก็บเงินของคุณ
   รายละเอียดและคัดลอกรหัส API ของคุณ
2. คุณรันคำสั่ง `/connect` ใน TUI เลือก KREONYX CLI Zen และวางคีย์ API ของคุณ
...
[model id](/docs/config/#models) ในการกำหนดค่า KREONYX CLI ของคุณ
ใช้รูปแบบ `kreonyx/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.2 Codex คุณจะต้อง
ใช้ `kreonyx/gpt-5.2-codex` ในการกำหนดค่าของคุณ
...
- GLM 4.7 ใช้งานได้ฟรีบน KREONYX CLI ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Kimi K2.5 Free พร้อมใช้งานบน KREONYX CLI ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- MiniMax M2.1 Free พร้อมใช้งานบน KREONYX CLI ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Big Pickle เป็นโมเดลล่องหนที่ให้บริการฟรีบน KREONYX CLI ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
...
เราสร้าง KREONYX CLI Zen เพื่อ:
...
4. **ไม่มีการล็อคอิน** โดยอนุญาตให้คุณใช้กับเอเจนต์การเขียนโค้ดอื่นๆ และให้คุณใช้ผู้ให้บริการรายอื่นกับ KREONYX CLI ได้เช่นกัน
