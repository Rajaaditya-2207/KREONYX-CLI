...
สร้าง `.kreonyx/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ KREONYX CLI:
...
- ระดับผู้ใช้ (Global): `~/.config/kreonyx/commands/`
- ระดับโปรเจ็กต์: `.kreonyx/commands/`
...
KREONYX CLI มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
