...
KREONYX CLI supports standard proxy environment variables and custom certificates for enterprise network environments.

---

## Proxy

KREONYX CLI respects standard proxy environment variables.
...
If your enterprise uses custom CAs for HTTPS connections, configure KREONYX CLI to trust them.
