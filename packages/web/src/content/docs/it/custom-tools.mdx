...
description: Crea strumenti che l'LLM puo chiamare in kreonyx.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di kreonyx come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.kreonyx/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/kreonyx/tools/`.
