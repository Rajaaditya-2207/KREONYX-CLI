---
title: Server LSP
description: KREONYX CLI si integra con i tuoi server LSP.
---

KREONYX CLI si integra con il tuo Language Server Protocol (LSP) per aiutare l'LLM a interagire con la tua codebase. Usa le diagnostiche per fornire feedback all'LLM.

---

## Integrati

KREONYX CLI include diversi server LSP integrati per linguaggi popolari:
...
Puoi personalizzare i server LSP tramite la sezione `lsp` nella configurazione di kreonyx.
