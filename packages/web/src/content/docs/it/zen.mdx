---
title: Zen
description: Lista curata di modelli fornita da KREONYX CLI.
---
...
KREONYX CLI Zen e una lista di modelli testati e verificati dal team di KREONYX CLI.

:::note
KREONYX CLI Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in KREONYX CLI. Accedi a KREONYX CLI Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare KREONYX CLI.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con KREONYX CLI.
:::
...
KREONYX CLI Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

KREONYX CLI Zen funziona come qualunque altro provider in KREONYX CLI.

1. Accedi a **<a href={console}>KREONYX CLI Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona KREONYX CLI Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di KREONYX CLI usa il formato `kreonyx/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `kreonyx/gpt-5.2-codex` nella config.
...
- GLM 4.7 Free e disponibile su KREONYX CLI per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Kimi K2.5 Free e disponibile su KREONYX CLI per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiniMax M2.1 Free e disponibile su KREONYX CLI per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su KREONYX CLI per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato KREONYX CLI Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con KREONYX CLI.
