...
Puoi aggiungere comandi personalizzati tramite la config di KREONYX CLI o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di KREONYX CLI:
...
- Globale: `~/.config/kreonyx/commands/`
- Per progetto: `.kreonyx/commands/`
...
kreonyx include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
