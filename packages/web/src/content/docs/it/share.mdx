---
title: Condivisione
description: Condividi le tue conversazioni KREONYX CLI.
---

La funzione di condivisione di KREONYX CLI ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, KREONYX CLI:
...
KREONYX CLI supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, KREONYX CLI usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `kreonyx.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare kreonyx nella tua organizzazione.
