...
Her er alle de innebygde verktøyene som er tilgængelige i KREONYX CLI.
...
:::note
Dette verktøyet er bare tilgængelig når du bruger KREONYX CLI-leverandøren eller når miljøvariabelen `OPENCODE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
