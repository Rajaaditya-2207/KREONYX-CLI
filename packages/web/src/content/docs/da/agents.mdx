...
Der er to typer agenter i KREONYX CLI; primære agenter og subagenter.
...
KREONYX CLI leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
KREONYX CLI leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

KREONYX CLI leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `kreonyx.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger KREONYX CLI modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale KREONYX CLI-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din KREONYX CLI-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [KREONYX CLI Zen](/docs/zen), vil du bruge `kreonyx/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `kreonyx models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/anomalyco/kreonyx).
:::
