...
Agentferdigheter lar KREONYX CLI oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
KREONYX CLI søker etter disse stedene:

- Prosjektkonfigurasjon: `.kreonyx/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/kreonyx/skills/<name>/SKILL.md`
...
For prosjektlokale stier går KREONYX CLI opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.kreonyx/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/kreonyx/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.kreonyx/skills/git-release/SKILL.md` slik:
...
KREONYX CLI viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `kreonyx.json`:
...
**For innebygde agenter** (i `kreonyx.json`):
