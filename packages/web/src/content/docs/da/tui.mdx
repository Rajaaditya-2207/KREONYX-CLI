---
title: TUI
description: Brug af KREONYX CLI-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KREONYX CLI giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre KREONYX CLI starter TUI for den nuværende mappe.
...
Når du bruger KREONYX CLI TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til KREONYX CLI. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut KREONYX CLI. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-adfærden gennem KREONYX CLI-konfigurationsfilen.
