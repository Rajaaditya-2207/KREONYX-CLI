---
title: LSP-servere
description: KREONYX CLI integreres med dine LSP-servere.
---

KREONYX CLI integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

KREONYX CLI leveres med flere indbyggede LSP-servere til populære sprog:
...
Når kreonyx åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din kreonyx-konfiguration.
