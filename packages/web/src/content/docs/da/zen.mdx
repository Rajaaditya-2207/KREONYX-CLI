---
title: Zen
description: Udvalgt liste over modeller leveret af KREONYX CLI.
---
...
KREONYX CLI Zen er en liste over testede og verificerede modeller leveret af KREONYX CLI-teamet.

:::note
KREONYX CLI Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i KREONYX CLI. Du logger på KREONYX CLI Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med KREONYX CLI.
:::
...
KREONYX CLI Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

KREONYX CLI Zen fungerer som alle andre udbydere i KREONYX CLI.

1. Du logger på **<a href={console}>KREONYX CLI Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger KREONYX CLI Zen og indsætter API-nøglen.
...
[model-id](/docs/config/#models) i KREONYX CLI-konfigurationen
bruger formatet `kreonyx/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `kreonyx/gpt-5.2-codex` i din konfiguration.
...
- GLM 4.7 Gratis er tilgængelig på KREONYX CLI i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Kimi K2.5 Gratis er tilgængelig på KREONYX CLI i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- MiniMax M2.1 Gratis er tilgængelig på KREONYX CLI i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på KREONYX CLI i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede KREONYX CLI Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med KREONYX CLI også.
