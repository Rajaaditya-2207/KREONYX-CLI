---
title: Deling
description: Del dine KREONYX CLI-samtaler.
---

KREONYX CLIs delingsfunksjon lar deg lage offentlige lenker til dine KREONYX CLI-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, KREONYX CLI:
...
KREONYX CLI støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger KREONYX CLI manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `kreonyx.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av kreonyx i organisasjonen din.
