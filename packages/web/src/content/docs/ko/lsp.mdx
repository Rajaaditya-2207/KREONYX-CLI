---
title: LSP 서버
description: KREONYX CLI는 LSP 서버와 통합되어 작동합니다.
---

KREONYX CLI는 언어 서버 프로토콜(LSP)과 통합되어 LLM이 코드베이스와 상호 작용할 수 있게 돕습니다. 이를 통해 진단 정보를 사용하여 LLM에 피드백을 제공합니다.

---

## 기본 제공 (Built-in)

KREONYX CLI는 인기 있는 언어들에 대해 여러 내장 LSP 서버를 제공합니다.
...
KREONYX CLI가 파일을 열 때, 다음과 같이 작동합니다:
...
KREONYX CLI 설정의 `lsp` 섹션을 통해 LSP 서버를 사용자 정의할 수 있습니다.
