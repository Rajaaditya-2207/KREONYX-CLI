---
title: Zen
description: KREONYX CLI가 제공하는 엄선된 모델 목록.
---
...
KREONYX CLI Zen은 kreonyx 팀에서 제공하는 테스트 및 검증된 모델 목록입니다.

:::note
KREONYX CLI Zen은 현재 베타입니다.
:::

Zen은 kreonyx의 다른 공급자와 같이 작동합니다. KREONYX CLI Zen에 로그인하고
...
:::tip
kreonyx와 잘 작동하는 모델 및 공급자의 선택 그룹을 테스트했습니다.
:::
...
KREONYX CLI Zen은 이 모델에 액세스 할 수있는 AI 게이트웨이입니다.

---

## 어떻게 작동합니까?

KREONYX CLI Zen은 kreonyx의 다른 공급자와 같습니다.

1. 로그인 **<a href={console}>KREONYX CLI Zen</a>**, 청구 추가
   세부 사항 및 API 키 복사.
2. TUI에서 `/connect` 명령을 실행하고 KREONYX CLI Zen을 선택하고 API 키를 붙여 넣으십시오.
...
kreonyx config에서 [model id](/docs/config/#models)
형식 `kreonyx/<model-id>`를 사용합니다. 예를 들어, GPT 5.2 Codex의 경우,
설정에서 `kreonyx/gpt-5.2-codex`를 사용합니다.
...
- GLM의 4.7 제한된 시간에 kreonyx에서 무료로 사용할 수 있습니다. 팀은 피드백을 수집하고 모델을 개선하기 위해이 시간을 사용합니다.
- 김이 K2.5 제한된 시간에 kreonyx에서 무료로 사용할 수 있습니다. 팀은 피드백을 수집하고 모델을 개선하기 위해이 시간을 사용합니다.
- 미니 맥스 M2.1 제한된 시간에 kreonyx에서 무료로 사용할 수 있습니다. 팀은 피드백을 수집하고 모델을 개선하기 위해이 시간을 사용합니다.
- Big Pickle은 제한된 시간 동안 kreonyx에서 무료 훔친 모델입니다. 팀은 피드백을 수집하고 모델을 개선하기 위해이 시간을 사용합니다.
...
4. 잠금 해제 \*\* 다른 코딩 에이전트와 함께 사용할 수 있도록. 그리고 항상 kreonyx와 다른 모든 공급자를 사용할 수 있습니다.
