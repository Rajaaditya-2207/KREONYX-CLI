...
kreonyx zawiera listę skrótów klawiszowych, które można zastosować poprzez kreonyx.
...
kreonyx używa klucza `leader` dla głównych skrótów klawiszowych. Rozwiązanie problemu konfliktów w terminalu.
...
Pole sprawdzania aplikacji komputerowej kreonyx obsługuje popularne skróty w stylu Readline/Emacs do edycji tekstu. Są one dostępne i obecnie nie można ich skonfigurować za pomocą `kreonyx.json`.
