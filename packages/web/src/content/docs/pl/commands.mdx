...
Utwórz `.kreonyx/commands/test.md`:
...
Możesz zdefiniować polecenia w `kreonyx.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji kreonyx:
...
- Globalnie: `~/.config/kreonyx/commands/`
- Na projekt: `.kreonyx/commands/`
...
kreonyx zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
