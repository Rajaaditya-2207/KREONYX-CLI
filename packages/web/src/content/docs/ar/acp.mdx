---
title: دعم ACP
description: استخدم KREONYX CLI في أي محرر متوافق مع ACP.
---

يدعم KREONYX CLI بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام KREONYX CLI عبر ACP، اضبط محررك ليشغّل الأمر `kreonyx acp`.

يشغّل هذا الأمر KREONYX CLI كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'KREONYX CLI' من محدد الوكلاء في AI Chat.
...
لاستخدام KREONYX CLI كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام KREONYX CLI كوكيل ACP للدردشة.
...
يعمل KREONYX CLI عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات KREONYX CLI
