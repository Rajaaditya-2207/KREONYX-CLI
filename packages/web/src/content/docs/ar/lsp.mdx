---
title: خوادم LSP
description: يتكامل KREONYX CLI مع خوادم LSP لديك.
---

يتكامل KREONYX CLI مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي KREONYX CLI مع عدة خوادم LSP مدمجة للغات الشائعة:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات kreonyx.
