...
:::caution
يتم الآن ضبط الأوضاع عبر خيار `agent` في إعدادات kreonyx. أصبح خيار
`mode` مُهمَلًا الآن. [اعرف المزيد](/docs/agents).
:::

تتيح لك الأوضاع في kreonyx تخصيص السلوك والأدوات والمطالبات لحالات استخدام مختلفة.

يأتي مع وضعين مدمجين: **build** و **plan**. يمكنك تخصيصهما أو إعداد
أوضاعك الخاصة عبر إعدادات kreonyx.
...
- `edit` - لا يمكن تعديل الملفات الموجودة، باستثناء الملفات الموجودة في `.kreonyx/plans/*.md` لتفصيل الخطة نفسها
...
قم بإعداد الأوضاع في ملف الإعدادات `kreonyx.json` لديك:
...
- عالمي: `~/.config/kreonyx/modes/`
- للمشروع: `.kreonyx/modes/`
...
إذا لم يتم تحديد درجة الحرارة، يستخدم kreonyx القيم الافتراضية الخاصة بكل نموذج (عادةً 0 لمعظم النماذج و 0.55 لنماذج Qwen).
...
إعدادات kreonyx العالمية وكذلك إعدادات المشروع.
...
أنشئ ملفات الأوضاع في `.kreonyx/modes/` لأوضاع خاصة بالمشروع أو في `~/.config/kreonyx/modes/` لأوضاع عالمية:
