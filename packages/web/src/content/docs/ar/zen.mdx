---
title: Zen
description: قائمة منتقاة من النماذج يوفّرها KREONYX CLI.
---
...
KREONYX CLI Zen هي قائمة بالنماذج التي اختبرها فريق KREONYX CLI وتحقّق منها.

:::note
KREONYX CLI Zen متاح حاليا بنسخة تجريبية.
:::

يعمل Zen مثل أي مزوّد آخر في KREONYX CLI. تسجّل الدخول إلى KREONYX CLI Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام KREONYX CLI.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع KREONYX CLI.
:::
...
KREONYX CLI Zen هو بوابة للذكاء الاصطناعي تتيح لك الوصول إلى هذه النماذج.

---

## كيف يعمل

يعمل KREONYX CLI Zen مثل أي مزوّد آخر في KREONYX CLI.

1. تسجّل الدخول إلى **<a href={console}>KREONYX CLI Zen</a>**، وتضيف تفاصيل الفوترة، ثم تنسخ مفتاح API.
2. تشغّل الأمر `/connect` في واجهة TUI، وتختار KREONYX CLI Zen، ثم تلصق مفتاح API.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات KREONYX CLI الصيغة `kreonyx/<model-id>`.
على سبيل المثال، بالنسبة إلى GPT 5.2 Codex ستستخدم `kreonyx/gpt-5.2-codex` في إعداداتك.
...
- GLM 4.7 Free متاح على KREONYX CLI لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Kimi K2.5 Free متاح على KREONYX CLI لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- MiniMax M2.1 Free متاح على KREONYX CLI لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على KREONYX CLI لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
4. عدم فرض **أي ارتباط حصري (lock-in)** عبر تمكينك من استخدامه مع أي عامل برمجة آخر، مع إتاحة استخدام أي مزوّد آخر مع KREONYX CLI أيضا.
