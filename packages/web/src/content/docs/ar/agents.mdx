...
يوجد نوعان من الوكلاء في KREONYX CLI: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي KREONYX CLI مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي KREONYX CLI مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي KREONYX CLI مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `kreonyx.json`:
...
- عام: `~/.config/kreonyx/agents/`
- لكل مشروع: `.kreonyx/agents/`
...
إذا لم يتم تحديد temperature، يستخدم KREONYX CLI القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات KREONYX CLI العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات KREONYX CLI الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [KREONYX CLI Zen](/docs/zen)، فستستخدم `kreonyx/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `kreonyx models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/kreonyx).
:::
