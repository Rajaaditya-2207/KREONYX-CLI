---
title: TUI
description: استخدام واجهة المستخدم TUI في KREONYX CLI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر KREONYX CLI واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل KREONYX CLI إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة KREONYX CLI في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى KREONYX CLI. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من KREONYX CLI. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات KREONYX CLI.
