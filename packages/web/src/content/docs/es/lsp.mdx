...
description: KREONYX CLI se integra con sus servidores LSP.
---

KREONYX CLI se integra con su protocolo de servidor de idiomas (LSP) para ayudar a LLM a interactuar con su código base. Utiliza diagnósticos para proporcionar retroalimentación al LLM.

---

## Incorporados

KREONYX CLI viene con varios servidores LSP integrados para idiomas populares:
...
Cuando kreonyx abre un archivo:
...
Puede personalizar los servidores LSP a través de la sección `lsp` en su configuración kreonyx.
