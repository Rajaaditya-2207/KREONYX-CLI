...
Crear `.kreonyx/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración KREONYX CLI o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su KREONYX CLI [config](/docs/config):
...
kreonyx incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
