---
title: Zen
description: Lista seleccionada de modelos proporcionada por KREONYX CLI.
---
...
KREONYX CLI Zen es una lista de modelos probados y verificados proporcionada por el equipo KREONYX CLI.

:::note
KREONYX CLI Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en KREONYX CLI. Inicias sesion en KREONYX CLI Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar KREONYX CLI.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con KREONYX CLI.
:::
...
KREONYX CLI Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

KREONYX CLI Zen funciona como cualquier otro proveedor en KREONYX CLI.

1. Inicias sesión en **<a href={console}>KREONYX CLI Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona KREONYX CLI Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de KREONYX CLI
usa el formato `kreonyx/<model-id>`. Por ejemplo, para GPT 5.2 Codex, debes
usar `kreonyx/gpt-5.2-codex` en tu configuracion.
...
- GLM 4.7 Free está disponible en KREONYX CLI por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Kimi K2.5 Free está disponible en KREONYX CLI por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- MiniMax M2.1 Free está disponible en KREONYX CLI por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en KREONYX CLI por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con KREONYX CLI también.
