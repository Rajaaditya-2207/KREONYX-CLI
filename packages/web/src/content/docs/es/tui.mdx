---
title: TUI
description: Usando la interfaz de usuario del terminal KREONYX CLI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KREONYX CLI proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar KREONYX CLI se inicia TUI para el directorio actual.
...
Cuando utilice KREONYX CLI TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a KREONYX CLI. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de KREONYX CLI. _Alias_: `/quit`, `/q`
...
Puede personalizar el comportamiento de TUI a través de su archivo de configuración KREONYX CLI.
