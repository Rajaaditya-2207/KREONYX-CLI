---
title: Compartir
description: Comparte tus conversaciones KREONYX CLI.
---

La función para compartir de KREONYX CLI te permite crear enlaces públicos a tus conversaciones de KREONYX CLI, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, KREONYX CLI:
...
KREONYX CLI admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, KREONYX CLI usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `kreonyx.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de kreonyx en su organización.
