...
`.kreonyx/commands/test.md` を作成します。
...
カスタムコマンドは、KREONYX CLI 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

KREONYX CLI [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/kreonyx/commands/`
- プロジェクトごと: `.kreonyx/commands/`
...
KREONYX CLI には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
