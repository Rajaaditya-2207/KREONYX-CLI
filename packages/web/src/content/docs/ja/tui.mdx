---
title: TUI
description: KREONYX CLI ターミナルユーザーインターフェイスの使用。
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KREONYX CLI は、LLM を使用してプロジェクトを作業するための対話型ターミナルインターフェイスまたは TUI を提供します。

KREONYX CLI を実行すると、現在のディレクトリの TUI が開始されます。
...
KREONYX CLI TUI を使用する場合、「`/`」に続いてコマンド名を入力すると、アクションをすばやく実行できます。例えば：
...
KREONYX CLI にプロバイダーを追加します。利用可能なプロバイダーから選択し、その API キーを追加できます。
...
KREONYX CLI を終了します。 _エイリアス_: `/quit`、`/q`
...
KREONYX CLI 設定ファイルを通じて TUI の動作をカスタマイズできます。
