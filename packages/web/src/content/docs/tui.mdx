---
title: TUI
description: Using the KREONYX CLI terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KREONYX CLI provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running KREONYX CLI starts the TUI for the current directory.
...
When using the KREONYX CLI TUI, you can type `/` followed by a command name to quickly execute actions. For example:
