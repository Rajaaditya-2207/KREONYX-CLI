---
title: ACP podrška
description: Koristite KREONYX CLI u bilo kojem uređivaču kompatibilnom sa ACP.
---

KREONYX CLI podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili KREONYX CLI putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `kreonyx acp`.

Naredba pokreće KREONYX CLI kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "KREONYX CLI" agenta u AI Chat agent selektoru.
...
Da koristite KREONYX CLI kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi KREONYX CLI kao ACP chat agenta.
...
KREONYX CLI radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj KREONYX CLI konfiguraciji
