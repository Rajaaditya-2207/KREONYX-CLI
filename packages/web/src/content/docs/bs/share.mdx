---
title: Dijeljenje
description: Dijelite KREONYX CLI razgovore javnim linkovima.
---

KREONYX CLI opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, KREONYX CLI:
...
KREONYX CLI podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, KREONYX CLI koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `kreonyx.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju kreonyx u organizaciji.
