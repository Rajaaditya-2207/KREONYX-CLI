...
Kreiraj `.kreonyx/commands/test.md`:
...
Možete dodati prilagođene komande kroz KREONYX CLI konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom KREONYX CLI [config](/docs/config):
...
- Globalno: `~/.config/kreonyx/commands/`
- Po projektu: `.kreonyx/commands/`
...
KREONYX CLI uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
