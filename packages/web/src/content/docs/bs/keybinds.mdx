...
KREONYX CLI ima listu veza tipki koje možete prilagoditi preko KREONYX CLI konfiguracije.
...
KREONYX CLI koristi `leader` (vodeću) tipku za većinu povezivanja tipki. Ovo izbjegava sukobe u vašem terminalu.
...
Unos prompta aplikacije KREONYX CLI za desktop podržava uobičajene prečice u stilu Readline/Emacs za uređivanje teksta. One su ugrađene i trenutno se ne mogu konfigurirati putem `kreonyx.json`.
