...
KREONYX CLI podržava standardne proxy varijable okruženja i prilagođene certifikate za enterprise mrežna okruženja.

## Proksi

KREONYX CLI poštuje standardne varijable proxy okruženja.
...
Ako vaše preduzeće koristi prilagođene CA-ove za HTTPS veze, konfigurirajte KREONYX CLI da im vjeruje.
