---
title: Zen
description: Kurirana lista modela koje nudi KREONYX CLI.
---
...
KREONYX CLI Zen je lista testiranih i provjerenih modela koje obezbjeduje KREONYX CLI tim.

:::note
KREONYX CLI Zen je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u KREONYX CLI. Prijavite se u KREONYX CLI Zen i uzmete API kljuc. Ovo je **potpuno opcionalno** i ne morate ga koristiti da biste koristili KREONYX CLI.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s KREONYX CLI.
:::
...
KREONYX CLI Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

KREONYX CLI Zen radi kao i svaki drugi provajder u KREONYX CLI.

1. Prijavite se na **<a href={console}>KREONYX CLI Zen</a>**, dodajte billing podatke i kopirajte API kljuc.
2. U TUI-ju pokrenite `/connect`, izaberite KREONYX CLI Zen i zalijepite API kljuc.
...
[model id](/docs/config/#models) u KREONYX CLI konfiguraciji koristi format `kreonyx/<model-id>`. Na primjer, za GPT 5.2 Codex u konfiguraciji koristite `kreonyx/gpt-5.2-codex`.
...
- GLM 4.7 Free je dostupan na KREONYX CLI ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
- Kimi K2.5 Free je dostupan na KREONYX CLI ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
- MiniMax M2.1 Free je dostupan na KREONYX CLI ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
- Big Pickle je stealth model koji je besplatan na KREONYX CLI ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
...
KREONYX CLI Zen smo napravili da:
...
4. Obezbijedimo **bez lock-ina** tako da Zen mozete koristiti sa bilo kojim coding agentom, uz slobodu koristenja drugih provajdera u KREONYX CLI.
