---
title: TUI
description: Korištenje korisničkog interfejsa KREONYX CLI terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KREONYX CLI pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje KREONYX CLI pokreće TUI za trenutni direktorij.
...
Kada koristite KREONYX CLI TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u KREONYX CLI. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz KREONYX CLI. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg KREONYX CLI konfiguracionog fajla.
