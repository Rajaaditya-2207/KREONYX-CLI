...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kreonyx.git")).toEqual({ owner: "sst", repo: "kreonyx" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kreonyx")).toEqual({ owner: "sst", repo: "kreonyx" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kreonyx.git")).toEqual({ owner: "sst", repo: "kreonyx" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kreonyx")).toEqual({ owner: "sst", repo: "kreonyx" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kreonyx.git")).toEqual({ owner: "sst", repo: "kreonyx" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kreonyx")).toEqual({ owner: "sst", repo: "kreonyx" })
})
